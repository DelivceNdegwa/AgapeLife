...
class DoctorSerializer(serializers.ModelSerializer):
    class Meta:
        model = Doctor
        fields = ('id', 'is_verified', 'profile_image', 'hospital', 'speciality', 'category', 'self_description', 'experience_years', 'first_name', 'last_name', 'phone_number', 'phone_number', 'password')
